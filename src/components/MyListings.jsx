...
export default function MyListings(props) {
  ...
  return (
    <div className="px-3 my-8 mx-auto">
      <h2 className="text-2xl text-center text-cyan-800 font-bold">
        My Listings
      </h2>

      <ul className="mt-10  sm:grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 sm:space-x-5  space-y-5 sm:space-y-0">
